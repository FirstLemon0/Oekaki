...
- 右パネル 400px、gap 16:
  ...
  - 今日完了: accent-soft 地 ＋ accent 枠。「今日の分は終わり」＋ check、題「明日は〜」22 700、副ボタン2つ「追加ドリル」「自由枠 10分」
...
### レッスン（read / drill）
- ヘッダ 80: 左 ✕（48）、中央 進捗セグメント 8px、右 mono「2/7」
...
### モーダル
- レッスン完了: 640 幅 radius 20 padding 40 44 32。44 の accent 丸チェック ＋ h3 28「今日の分は終わり。」、メタ 16 ink-2、3 統計カード（XP mono 32「+30」/ 楕円 accent-soft「▲+20 個」/ ストリーク 炎 ＋ mono 32「24日」「23 → 24」）、「明日はこれ」枠行、3 ボタン（副・副・主「ホームへ」）
- ステージ修了: 1040×720 radius 24 grid 460 | 1fr。左 canvas 地に卒業課題の絵 ＋ キャプション。右 padding 56: 「STAGE 1 修了」accent-text .12em、h3 40 700 2 行、本文 16 ink-2 1.8、下寄せに ink 地の NEXT カード（「NEXT · STAGE 1.5」11 .12em opacity .6、題 20 700、「6 レッスン · 明日から」13 opacity .7、右に chevron accent-on-dark）、副「Before と見比べる」・主「ホームへ」

## 4. 縦向き（920×1472）
- ホーム: ヘッダ 80 ピル群 ＋ Lv。今日カード（横並び: 題 22 ＋ 主ボタン 56）。累計チップ横スクロール（56 高 min-width 128）。中央にステージバナー ＋ パス 520。下部ナビ 88 surface ＋ 上罫線、項目 120×64
- キャンバス: 上端 16px にツールバー横並び（48 ボタン）＋ 右端カウンター、その下 92px に課題ピル。左下ペンのみ、右下 完了
...
- ロック: タップで左右 3px に 1 回だけ振れ（.4s）、トースト「明日開きます」。赤や✕は出さない
...
## 7. 文言（変更なし）
丁寧だが短い。「今日の1歩」「始める」「描く」「今日の分は終わり。」「先生が見ています…」「点数はつけません。言葉で見ます」「明日開きます」。「うまい／へた」「✕」を使わない。
